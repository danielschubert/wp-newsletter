 ...
 *
 * Modified by Daniel Schubert <mail@schubertdaniel.de>  27 Oct 2015
 * to meet the requirements for www.rainervonvielen.de
 *
 * @param string|array $to Array or comma-separated list of email addresses to send message.
 * @param string $subject Email subject
 * @param string $html_message  HTML Message contents
 * @param string $txt_message Optional Text Message contents
 * @param string $deliverytime Optional Deliverytime e.g. "Thur, 30 Oct 2015 21:46:00 +0200"
 * @param string|array $headers Optional. Additional headers.
 * @param string|array $attachments Optional. Files to attach.
 * @return bool Whether the email contents were sent successfully.
 * @since 0.1
 */
function wp_mail( $to, $subject, $html_message, $txt_message,  $headers = '', $deliverytime = '', $attachments = array() ) {
	// Compact the input, apply the filters, and extract them back out
	extract( apply_filters( 'wp_mail', compact( 'to', 'subject', 'html_message', 'txt_message', 'headers', 'deliverytime', 'attachments' ) ) );
	...
	if ($deliverytime != '')
		$body['o:deliverytime'] = $deliverytime;
