 ...
 * @since 0.1
 */
function wp_mail( $to, $subject, $html_message, $txt_message, $headers = '', $attachments = array() ) {
	// Compact the input, apply the filters, and extract them back out
	extract( apply_filters( 'wp_mail', compact( 'to', 'subject', 'html_message', 'txt_message','headers', 'attachments' ) ) );
	...
	if ( $content_type == 'text/html' ) {
		$body['html'] = $html_message;
		$body['text'] = strip_tags( $txt_message );
	}
